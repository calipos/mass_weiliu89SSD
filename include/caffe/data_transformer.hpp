...
//trans blob for segment data
    void Transform(const Datum& img_datum,
...
//for transf the img,mask pair Data
...
void Transform(const cv::Mat& cv_img,
                                       Blob<Dtype>* transformed_blob,
                                       bool* do_mirror);
void TransformForSegmentImage(const cv::Mat& cv_img,
                                       Blob<Dtype>* transformed_blob,
                                       bool* do_mirror,
                                       int *crop_h_off,
                                       int *crop_w_off);
void TransformForSegmentMask(const cv::Mat& cv_img,
                                       Blob<Dtype>* transformed_blob,
                                       bool do_mirror,
                                       int crop_h_off,
                                       int crop_w_off);
